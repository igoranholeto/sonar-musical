...
const POSTS = [
  ...
  { slug: 'como-fazer-pestana-na-guitarra', kicker: 'INICIANTES', l1: 'COMO FAZER', l2: 'PESTANA', sub: 'o acorde F sem sofrer', motif: 'fretboard' },
  { slug: 'como-fazer-bend-na-guitarra', kicker: 'TÉCNICA E TEORIA', l1: 'COMO FAZER', l2: 'BEND', sub: 'afinado e sem dor', motif: 'fretboard' },
  { slug: 'como-ler-tablatura-de-guitarra', kicker: 'INICIANTES', l1: 'COMO LER', l2: 'TABLATURA', sub: 'linhas · números · símbolos', motif: 'tab' },
