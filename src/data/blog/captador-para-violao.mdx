...
<ComparativoProdutos
  ...
  linhas={[
    { celulas: ["Magnético de boca", "Encaixa na boca (fácil)", "Encorpado, meio 'elétrico'", "Baixa (ótimo ao vivo)", "R$ 150–3.800"], destaque: true, badge: "Mais prático" },
    { celulas: ["Transdutor piezo (sob o rastilho)", "Precisa de luthier", "Brilhante, direto", "Baixa", "R$ 150–1.200 (com pré)"] },
...
<ComparativoProdutos
  ...
  linhas={[
    ...
    { celulas: ["LR Baggs M1 / M80", "Magnético de boca (ativo)", "Palco sério, controle de feedback", "R$ 3.500–4.000"] },
    { celulas: ["Fishman Presys / Matrix", "Piezo sob o rastilho + pré", "Eletroacústico completo", "R$ 150–500"] },
...
<AfiliadoCTA
  produto="LR Baggs M1"
  descricao="Captador magnético ativo de boca — sinal forte e equalizado, com controle de feedback para o palco"
  preco="A partir de R$ 3.836"
  avaliacao={4.8}
  categoria="acessorio"
  badge="Palco Sério"
  destaques={["Magnético ativo, com sinal forte e pronto para a mesa", "Ótimo para banda e volume alto", "Referência entre os magnéticos de boca"]}
  url="https://meli.la/1cMGDm1"
/>

<AfiliadoCTA
  produto="Fishman Presys"
  descricao="Sistema piezo Fishman para violão — timbre direto e muito resistente à microfonia, base dos eletroacústicos"
  preco="A partir de R$ 149"
  avaliacao={4.4}
  categoria="acessorio"
  badge="Sistema Piezo"
  destaques={["Timbre direto e muito resistente à microfonia", "O padrão dos violões eletroacústicos", "Instalação sob o rastilho, por luthier"]}
  url="https://meli.la/1KJMXHX"
/>
...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Um captador magnético nacional de entrada fica em torno de R$ 150; modelos importados como o Fishman Neo-D, na faixa de R$ 600 a R$ 750; sistemas piezo com pré, a partir de cerca de R$ 150; magnéticos ativos importados como o LR Baggs M1, entre R$ 3.500 e R$ 4.000; e os híbridos (piezo + microfone) como o LR Baggs Anthem, de R$ 3.000 a R$ 3.600. São preços estimados de mercado — confira o valor atual na loja antes de comprar."
  },
  {
