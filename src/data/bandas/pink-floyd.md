...
ano: 1965
blurb: "Solos que respiram: delays espaçosos, sustain infinito e um Stratocaster
  preto que virou lenda nas mãos de Gilmour."
fotoCapa: /images/pink-floyd-sonar.webp
fotoCapaAlt: pink floyd
fotoCapaPosition: 10
integrantes:
  - foto: /images/david-gilmour-sonar.webp
    fotoAlt: david glimour
    pontos:
    ...
    resumo: David Gilmour entrou para o Pink Floyd em 1968 e se tornou o principal
      guitarrista e uma das vozes da banda. Ficou famoso pelos bends longos com
      sustain quase infinito e pelo uso extensivo de delay para criar espaço e
      atmosfera, tocados principalmente em sua Stratocaster apelidada de "The
      Black Strat".
    nome: David Gilmour
    setup:
      - tipo: Guitarra
...
albuns:
  - ano: 1973
    ...
    descricao: Um dos álbuns mais vendidos da história, explora temas como tempo,
      dinheiro e sanidade em uma sequência conceitual contínua.
    temas:
      - tema: Passagem do tempo e mortalidade
        explicacao: A faixa "Time" abre com um coro de despertadores e relógios tocando
          fora de sincronia, seguido pela reflexão de Roger Waters sobre acordar
          um dia e perceber que boa parte da vida já passou esperando por alguém
          ou algo para mostrar o caminho. É o núcleo do álbum sobre
          oportunidades perdidas e a consciência da própria mortalidade.
      ...
      - tema: Loucura e saúde mental
        explicacao: O álbum nasceu em parte da preocupação da banda com o estado mental
          de Syd Barrett, fundador do Pink Floyd afastado por crises psicóticas.
          A linha "eu te encontro no lado escuro da lua" e o verso "there's
          someone in my head but it's not me", em "Brain Damage", tratam
          diretamente da fragilidade da mente.
      ...
      - tema: Ciclo contínuo da vida
        explicacao: O álbum não tem pausas entre as faixas — tudo é costurado por
          ...
          experiência única e ininterrupta.
    ...
    secoesAnalise:
      - titulo: Gravação e produção
        texto: The Dark Side of the Moon foi gravado em cerca de 60 dias, divididos
          ...
          loops de fita e o sintetizador EMS Synthi A. As falas espalhadas pelo
          disco, incluindo a icônica frase "there is no dark side of the moon
          really, matter of fact it's all dark", vieram de entrevistas informais
          que a equipe fez com funcionários e músicos que passavam pelo estúdio.
  ...
  - ano: 1975
    descricao: Homenagem a Syd Barrett, traz a suíte "Shine On You Crazy Diamond" e
      reflexões sobre a indústria da música.
    temas:
      - tema: Ausência e ruptura com Syd Barrett
        explicacao: A suíte "Shine On You Crazy Diamond" foi composta como homenagem a
          Syd Barrett, o fundador do Pink Floyd afastado por causa de crises
          psiquiátricas. Segundo Roger Waters, a canção não é exatamente sobre
          Barrett, mas usa sua história como símbolo dos extremos da ausência
          que algumas pessoas precisam viver. O impacto ficou ainda mais forte
          quando Barrett, irreconhecível fisicamente, apareceu sem avisar no
          estúdio durante a mixagem final do disco, em 5 de junho de 1975.
      - tema: Crítica à indústria da música
        explicacao: As faixas "Welcome to the Machine" e "Have a Cigar" satirizam a
          exploração comercial dos artistas pelas gravadoras. "Have a Cigar"
          traz a famosa linha perguntando qual deles era o "Pink", inspirada em
          um episódio real com um executivo que nem sabia quem era o líder da
          banda.
      ...
      - tema: Vazio pós-sucesso
        explicacao: Depois do estrondoso sucesso de "The Dark Side of the Moon", a banda
          enfrentou uma crise criativa e pessoal que aparece nas letras como uma
          sensação de vazio e desconexão, mesmo cercada de reconhecimento e
          dinheiro.
    ...
    secoesAnalise:
      - titulo: Gravação e produção
        texto: As sessões de "Wish You Were Here" aconteceram entre janeiro e julho de
          1975 nos estúdios de Abbey Road, com o engenheiro Brian Humphries no
          lugar de Alan Parsons. O processo foi descrito por Roger Waters como
          torturante, em parte pela pressão de repetir o sucesso do álbum
          anterior. Um erro técnico chegou a estragar uma gravação inteira de
          "Shine On", quando Humphries aplicou eco por engano, obrigando a banda
      ...
      - titulo: O favorito da própria banda
        texto: Apesar de "The Dark Side of the Moon" ser o álbum mais vendido do grupo,
          Richard Wright, David Gilmour e Nick Mason chegaram a citar "Wish You
          Were Here" como seu trabalho favorito na carreira do Pink Floyd,
          enquanto Roger Waters o considerou, ao lado do antecessor, o disco
          mais completo que a banda já fez.
    scoresCriticos:
      - fonte: AllMusic
        nota: 5
        notaMax: 5
  ...
  - ano: 1977
    descricao: Álbum conceitual inspirado em "A Revolução dos Bichos", de George
      Orwell, com guitarras mais ásperas que os discos anteriores.
    temas:
      ...
      - tema: Cães como metáfora do mundo corporativo
        explicacao: A faixa "Dogs", com mais de 17 minutos e coescrita com David
          Gilmour, retrata o executivo agressivo treinado para vencer a qualquer
          custo, escondendo atrás do comportamento "adestrado" uma
          competitividade brutal que, no fim, o deixa sozinho e amargurado.
      - tema: Porcos como elite dominante
        explicacao: Em "Pigs (Three Different Ones)", Waters mira figuras públicas
      ...
      - tema: Ovelhas e a massa alienada — só que rebelde
        explicacao: A faixa "Sheep" descreve a maioria passiva e manipulada da
          ...
          mais vingativo do que o do livro original.
      - tema: Amor como contraponto humano
        explicacao: As duas partes de "Pigs on the Wing", que abrem e fecham o disco,
          fogem do tom cínico do restante do álbum e trazem uma declaração de
          afeto de Waters para sua então nova esposa, sugerindo que só a conexão
          humana genuína protege da frieza do sistema descrito nas faixas
          centrais.
    ...
    secoesAnalise:
      - titulo: Gravação em casa nova
        texto: O álbum "Animals" foi o primeiro gravado no Britannia Row, estúdio
      ...
      - titulo: O porco que fugiu de Battersea
        texto: A capa, com um porco inflável de 12 metros batizado de "Algie" flutuando
          entre as chaminés da usina de Battersea, foi criada por Roger Waters
          em parceria com Storm Thorgerson, da dupla de design Hipgnosis.
          Durante a sessão de fotos, uma rajada de vento arrancou o porco de
          suas amarras, e ele subiu a milhares de metros de altitude, chegou a
          ser avistado por pilotos de avião, forçou o cancelamento de voos em
          Heathrow e só foi encontrado horas depois em uma fazenda no condado de
          Kent, para desespero do fazendeiro, cujas vacas se assustaram com a
          aparição.
      - titulo: O disco "punk" do Pink Floyd
        texto: Lançado poucos meses antes da explosão do punk rock no Reino Unido,
  ...
  - ano: 1979
    ...
    descricao: Ópera rock sobre isolamento e trauma, um dos discos duplos mais
      icônicos do rock, com "Another Brick in the Wall".
    temas:
      - tema: Perda do pai na guerra
        explicacao: A morte do pai de Pink, o protagonista do álbum, na Segunda Guerra
          Mundial espelha diretamente a biografia de Roger Waters, cujo pai
          morreu em combate em 1944, quando ele tinha apenas 5 meses de idade.
          Esse trauma é apresentado como o primeiro "tijolo" do muro emocional
          do personagem.
      - tema: Abuso institucional e educação opressiva
        explicacao: A faixa "Another Brick in the Wall, Pt. 2" ataca o sistema escolar
          rígido e humilhante que Waters viveu na infância, com o famoso coro
          infantil "we don't need no education" cantado por crianças da
          Islington Green School, em Londres.
      - tema: Superproteção materna
        explicacao: Na faixa "Mother", Pink lida com uma mãe sufocante e superprotetora,
          que alimenta ainda mais seu isolamento ao tentar protegê-lo de tudo,
          inclusive do próprio mundo exterior.
      - tema: Colapso do casamento e isolamento
        explicacao: Faixas como "Don't Leave Me Now" e "One of My Turns" tratam da
          deterioração do casamento de Pink, alimentada pela infidelidade e pela
          incapacidade de se conectar emocionalmente com a esposa, reforçando
          cada novo "tijolo" no muro que ele constrói ao redor de si mesmo.
    ...
    secoesAnalise:
      - titulo: Gravação sob pressão
        texto: As gravações de "The Wall" se estenderam de dezembro de 1978 a novembro
          de 1979, passando pelo estúdio Britannia Row em Londres e por estúdios
          na França e nos Estados Unidos. O produtor Bob Ezrin foi contratado
          para mediar as tensões crescentes entre Roger Waters e o restante da
      ...
      - titulo: Do disco ao cinema
        texto: Em 1982, "The Wall" ganhou uma adaptação para o cinema dirigida por Alan
          Parker, com roteiro do próprio Roger Waters, o cantor Bob Geldof no
      ...
      - titulo: Recepção dividida, legado consagrado
        texto: Na época do lançamento, a crítica ficou dividida — a Rolling Stone
          ...
          óperas rock mais ambiciosas já feitas, foi incluído no Grammy Hall of
          Fame em 2008 e permaneceu 15 semanas no topo da Billboard 200
          americana.
    scoresCriticos:
      - fonte: AllMusic
        nota: 4.5
